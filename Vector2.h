...
public:
    ...
    constexpr Vector2<T> operator+=(const Vector2<T> &o) noexcept {
        _x = _x + o._x;
        _y = _y + o._y;
        return *this;
    }
    ...
    constexpr Vector2<T> operator*=(T s) noexcept {
        _x = _x * s;
        _y = _y * s;
        return *this;
    }

    constexpr Vector2<T> operator/=(T s) {
        _x = _x / s;
        _y = _y / s;
        return *this;
    }
    ...
    constexpr Vector2<T> rotate(double angle) noexcept {
